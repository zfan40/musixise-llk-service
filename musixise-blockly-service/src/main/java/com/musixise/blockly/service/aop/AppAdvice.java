package com.musixise.blockly.service.aop;
...
public class AppAdvice implements Ordered {
    ...
    @Pointcut("@annotation(com.musixise.blockly.service.aop.AppMethod)")
    ...
    @Before("within(com.musixise.blockly..*)")
    ...
    @AfterReturning(pointcut = "within(com.musixise.blockly..*)", returning = "rvt")
    ...
    @AfterThrowing(pointcut = "within(com.musixise.blockly..*) && @annotation(appMethod)", throwing = "ex")
